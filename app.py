...
quantitative_cols = ['involved/normal', 'number of vertebrae involved', 'Number of intervertebral discs destroyed',
                     'CRP', 'N%', 'L', 'Age', 'Height(m)']
...
if st.button("开始预测"):
    ...
    input_df_scaled = scaler.transform(input_df[scaler.feature_names_in_])  # 保证列名与培训时一致
